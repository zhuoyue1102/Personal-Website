...
export const DEFAULT_PROFILE: ProfileConfig = {
  ...
  avatarUrl: '/src/assets/images/profile_photo_1779758202074.png',
  bannerUrl: 'https://images.unsplash.com/photo-1634017839464-5c339ebe3cb4?auto=format&fit=crop&q=80&w=1200&h=400',
  darkBannerUrl: 'https://images.unsplash.com/photo-1634017839464-5c339ebe3cb4?auto=format&fit=crop&q=80&w=1200&h=400',
  ...
  scholarUsername: 'Zhuoyue Zhao / 赵卓越',
  themePreset: 'auto',
  ...
  instagramPostsList: [
    {
      ...
      imageUrl: 'src/assets/images/I1.jpg',
      likes: '7',
      comments: '0',
    }
  ],
  bilibiliVideosList: [
    {
      title: '【新疆纪行】长这么大总要去趟新疆吧！',
      duration: '9:27',
      imageUrl: 'src/assets/images/B2.png',
      url: 'https://www.bilibili.com/video/BV14nYdeCE4T/?spm_id_from=333.1387.homepage.video_card.click',
      likes: '24',
      comments: '7',
      playCount: '',
    },
    {
      title: '《风华·忆》｜ 宁波惠贞书院2021届一班毕业视频',
      duration: '5:35',
      imageUrl: 'src/assets/images/B1.png',
      url: 'https://www.bilibili.com/video/BV13y4y1M7fn/?spm_id_from=333.1387.homepage.video_card.click&vd_source=92206fc979652c82a107395f12c2b644',
      likes: '32',
      comments: '15',
      playCount: '',
    }
